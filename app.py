...
#authentication
sp = spotipy.Spotify(auth_manager=SpotifyOAuth(client_id=SPOTIPY_CLIENT_ID, client_secret=SPOTIPY_CLIENT_SECRET,cache_path='/Users/blakemartinez/Downloads/spotifyProject-main/.cache', redirect_uri=SPOTIPY_REDIRECT_URI, scope=SCOPE))
